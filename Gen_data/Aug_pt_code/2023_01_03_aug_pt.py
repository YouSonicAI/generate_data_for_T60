...
parser.add_argument('--csv_file', type=str,
                    default="/data/STI_New_Wav/Dev/Speech/Four_Config/20220921T140847_test_gen_corpus_dataset_results.csv")
parser.add_argument('--dir_str', type=str,
                    default="/data/STI_New_Wav/Dev/Speech/Four_Config/")
parser.add_argument('--save_dir', type=str,
                    default="/data/xbj/0922_STI_FPN/train/Four_Config/")
...
for file_name in glob.glob(dir_str + r"/*.wav"):
    ...
    for audio_samples_np, clean_audio_samples_np in zip(wave_data, clean_wave_data):
        ...
        for t in cut_parameters:
            ...
            sample = {'image': image, 'clean':clean_image, 'ddr': DDR_each_band, 't60': T60_each_band, "MeanT60": MeanT60_each_band}
            transform = Totensor()
