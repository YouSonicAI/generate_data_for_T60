...
def excel_to_csv(file):
    ...
    resultsFileName = "12_28_1000_HZ.csv"
...
parser.add_argument("--csv_file",default="/data2/new_wzd/1000Hz/modif_code/12_28_1000_HZ.csv",type=str)
...
parser.add_argument('--input_dir',default="/data2/new_wzd/1000Hz/RIR_Data",type=str)
parser.add_argument("--output_dir",default="/data2/new_wzd/1000Hz/modif_output_wav",type=str)
parser.add_argument("--gen_convwav_shell",default='/data2/new_wzd/1000Hz/modif_code/new_conv_wav.sh',type = str)
...
if __name__ == "__main__":
    ...
    file = "/data2/new_wzd/1000Hz/2022_12_28_new_1000.xls"
    ...
    # with open(args.csv_file,'r') as f:
        ...
        for key in np.arange(min_key,max_key+round(args.split_internal,1),round(args.split_internal,1)):
            key = round(key,1)
            ...
            for value in values:
                ...
                args.input_dir, args.output_dir,scene_name,scene_name)
