...
parser.add_argument('--wave_dir',default="/data2/new_wzd/1000Hz/modif_output_wav/Dev/Speech/", type=str)
parser.add_argument("--output_pt_dir",default="/data1/wzd/2023-01-03-STI-Pt", type=str)
parser.add_argument("--gen_shell",default='/data2/new_wzd/1000Hz/pt_code/wav_to_pt.sh', type=str)
